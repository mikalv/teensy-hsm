...
#define AES_CCM_MAX_DATA_SIZE_BITS      512
#define AES_CCM_MAX_DATA_SIZE_BYTES     (AES_CCM_MAX_DATA_SIZE_BITS / 8)
#define AES_CCM_MAX_AEAD_SIZE_BYTES     (AES_CCM_MAX_DATA_SIZE_BYTES + AES_CCM_MAC_SIZE_BYTES)
#define AES_CCM_AEAD_SIZE_BYTES         (AES_BLOCK_SIZE_BYTES + AES_CCM_NONCE_SIZE_BYTES + AES_CCM_MAC_SIZE_BYTES)
